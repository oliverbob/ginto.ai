...
$router->get('/admin/promocodes', 'PromoCodesAdminController@index');
$router->post('/admin/promocodes/create', 'PromoCodesAdminController@store');
$router->get('/admin/promocodes/validate', 'PromoCodesAdminController@validate');
$router->post('/admin/promocodes/validate', 'PromoCodesAdminController@validate');
$router->post('/admin/promocodes/{id}/update', 'PromoCodesAdminController@update');
$router->post('/admin/promocodes/{id}/toggle', 'PromoCodesAdminController@toggle');
$router->post('/admin/promocodes/{id}/delete', 'PromoCodesAdminController@delete');
