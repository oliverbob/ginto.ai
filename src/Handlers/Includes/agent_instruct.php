...
return [
    ...
    'visitor' => function(): string {
        return "\n\n## VISITOR MODE (NOT LOGGED IN)\n"
            ...
            . "[**Create Free Account →**](https://silverqueen.pro/register)\"\n\n"
    ...
    'productInfo' => function(): string {
        return "\n\n## GINTO PRODUCTS & SUBSCRIPTION PLANS\n"
            ...
            . "   - **Flat monthly subscription: ₱250/month**\n"
            ...
            . "**1. Registration:**\n"
            . "   - Visit [silverqueen.pro/register](https://silverqueen.pro/register)\n"
            ...
            . "   - Your referral link: `https://silverqueen.pro/register?ref=YOUR_USERNAME`\n"
            ...
            . "The Starter Plan is a flat ₱250/month subscription.\n"
            . "All commission calculations below use the **₱250 monthly base**.\n\n"
            . "**Starter Plan (₱250/month) – Power 10 – 8-Day Income Projection**\n\n"
            . "| Day | People | % Rate | Commission Each | Income |\n"
            . "|-----|--------|--------|-----------------|--------|\n"
            . "| Day 1 | 10 | 5% | ₱12.50 | ₱125.00 |\n"
            . "| Day 2 | 100 | 4% | ₱10.00 | ₱1,000.00 |\n"
            . "| Day 3 | 1,000 | 3% | ₱7.50 | ₱7,500.00 |\n"
            . "| Day 4 | 10,000 | 2% | ₱5.00 | ₱50,000.00 |\n"
            . "| Day 5 | 100,000 | 1% | ₱2.50 | ₱250,000.00 |\n"
            . "| Day 6 | 1,000,000 | 0.5% | ₱1.25 | ₱1,250,000.00 |\n"
            . "| Day 7 | 10,000,000 | 0.25% | ₱0.625 | ₱6,250,000.00 |\n"
            . "| Day 8 | 100,000,000 | 0.25% | ₱0.625 | ₱62,500,000.00 |\n\n"
            . "- **TOTAL PEOPLE (After 8 Days): 111,111,110**\n"
            . "- **TOTAL INCOME (After 8 Days): ₱70,308,625.00**\n\n"
            ...
            . "**[Subscribe to Ginto](https://silverqueen.pro/register)**\n"
