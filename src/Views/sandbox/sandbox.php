        ...
        <div class="dashboard">
            ...
            <div class="card">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="cpuLimit" value="1" min="0.5" max="16" step="0.5">
                    <small style="color: #888; display: block; margin-top: 4px;">Limited to available CPUs on server</small>
                </div>
                <div class="form-group">
