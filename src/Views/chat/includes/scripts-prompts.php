      ...
      hintArea.innerHTML = `
        <div class="w-full max-w-4xl mx-auto">
          <a href="/academy" aria-label="Ginto Trading Academy" style="display:block;text-decoration:none;border-radius:16px;overflow:hidden;box-shadow:0 12px 40px rgba(99,102,241,0.25);">
            <div style="background:linear-gradient(135deg,#4f46e5,#7c3aed 55%,#8b5cf6);padding:26px;color:#fff;display:flex;flex-wrap:wrap;align-items:center;gap:26px;">
              ...
              <div id="home-academy-charts" style="flex:1 1 300px;min-width:240px;display:flex;flex-direction:column;gap:12px;"></div>
            </div>
          </a>
