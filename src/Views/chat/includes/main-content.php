    ...
    <div class="flex items-center justify-between px-4 h-14">
      ...
      <div class="flex items-center gap-2">
        ...
        <div class="relative" id="model-selector-wrapper">
          ...
          <!-- Dropdown menu -->
          <div id="model-dropdown" class="hidden absolute left-0 mt-2 w-auto min-w-[10rem] max-w-md max-h-[60vh] overflow-hidden bg-white dark:bg-gray-900 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 z-20 flex flex-col">
