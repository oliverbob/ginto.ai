...
<header id="mobile-header" class="lg:hidden fixed top-0 left-0 right-0 z-40 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-4 py-2">
  ...
  <div class="flex items-center gap-2 flex-1 min-w-0 mobile-hide-on-tiny">
    ...
    <button id="model-selector-btn-mobile" class="flex items-center gap-2 px-2 h-8 min-h-8 py-0.5 bg-gray-100 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors cursor-pointer hidden min-[350px]:inline-flex flex-1 min-w-0 justify-start overflow-hidden" aria-haspopup="true" aria-expanded="false">
    ...
    <div id="model-dropdown-mobile" class="hidden fixed top-12 left-1/2 transform -translate-x-1/2 w-[350px] min-w-[350px] max-w-[350px] bg-white dark:bg-gray-900 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 z-50 max-h-[50vh] overflow-hidden flex flex-col">
  ...
  <div class="flex items-center gap-1 mobile-hide-on-tiny">
    ...
    <a href="https://github.com/oliverbob/ginto.ai" target="_blank" class="p-1.5 rounded-lg text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors" title="Star us on GitHub">
