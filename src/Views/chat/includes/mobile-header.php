...
<header id="mobile-header" class="lg:hidden fixed top-0 left-0 right-0 z-40 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-4 py-2">
  ...
  <div class="flex items-center gap-1">
    ...
    <!-- Compact AI icon shown at <=300px (logged-in group) -->
    <button id="mobile-ai-icon-loggedin" onclick="document.getElementById('model-selector-btn-mobile')?.click()" class="p-1.5 rounded-lg text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors hidden show-ai-icon-on-300" title="Models">
      <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <button id="mobile-ai-icon" onclick="document.getElementById('model-selector-btn-mobile')?.click()" class="p-1.5 rounded-lg text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors hidden show-ai-icon-on-300" title="Models">
      <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 3v3M12 18v3M4.22 4.22l2.12 2.12M17.66 17.66l2.12 2.12M4 12H1M23 12h-3M4.22 19.78l2.12-2.12M17.66 6.34l2.12-2.12M7 7h10v10H7z"/>
      </svg>
    </button>
