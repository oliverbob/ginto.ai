        ...
        <form id="settings-form">
            ...
            <div id="tab-users" class="tab-content">
                ...
                <div class="section-card">
                    ...
                    <p class="help-text mb-4">Set up the administrator account for managing Silverqueen.pro</p>
                ...
                <div class="section-card">
                    ...
                    <div class="grid md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <p class="help-text mt-1">Webhook URL: <code class="text-xs">https://silverqueen.pro/webhooks/paymongo</code></p>
                        </div>
                        <div>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="site_url" class="input-field" 
                                   ...
                                   placeholder="https://silverqueen.pro">
                        </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="imagegen_compute_mode" class="input-field">
                                ...
                                <option value="gpu" <?= (($envValues['IMAGEGEN_COMPUTE_MODE'] ?? 'auto') === 'gpu') ? 'selected' : '' ?>>GPU/Tunnel (Force vision.silverqueen.pro endpoint)</option>
                            </select>
