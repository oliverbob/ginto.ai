...
<aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 transform transition-transform duration-300 bg-white dark:bg-gray-800 -translate-x-full lg:translate-x-0 flex flex-col h-screen">
    ...
    <nav class="flex-1 px-2 space-y-0.5 overflow-y-auto min-h-0 pb-6 pr-2">
        ...
        <!-- Promo Codes -->
        <a href="/admin/promocodes" class="w-full flex items-center space-x-3 px-4 py-1 transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/promocodes') ?> <?= activeIconClass('/admin/promocodes') ?>">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5" style="color: #f97316;">
        ...
        <!-- Membership Tiers -->
        <a href="/admin/tier" class="w-full flex items-center space-x-3 px-4 py-1 transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/tier') ?> <?= activeIconClass('/admin/tier') ?>">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5" style="color: #10b981;">
        ...
        <!-- Referral Links -->
        <a href="/admin/referrallinks" class="w-full flex items-center space-x-3 px-4 py-1 transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/referrallinks') ?> <?= activeIconClass('/admin/referrallinks') ?>">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5" style="color: #3b82f6;">
                <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/>
                <path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/>
            </svg>
            <span class="font-medium">Referral Links</span>
        </a>
        ...
        <!-- Network Dashboard (LXD Network Mode Manager) -->
        <a href="/admin/network" class="w-full flex items-center space-x-3 px-4 py-1 transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/network') ?> <?= activeIconClass('/admin/network') ?>">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5" style="color: #f59e0b;">
        ...
        <!-- Server Hosting (Virtualmin/CyberPanel-style) -->
        <a href="/admin/hosting" class="w-full flex items-center space-x-3 px-4 py-1 transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/hosting') ?> <?= activeIconClass('/admin/hosting') ?>">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5" style="color: #10b981;">
            ...
            <span class="font-medium">Server Hosting</span>
        </a>
