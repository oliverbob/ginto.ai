...
<aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 transform transition-transform duration-300 bg-white dark:bg-gray-800 -translate-x-full lg:translate-x-0 flex flex-col h-screen">
    ...
    <nav class="flex-1 px-2 space-y-2 overflow-y-auto min-h-0 pb-6 pr-2">
        <!-- CMS: Admin Dashboard (content overview) -->
        <a href="/admin" class="w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin') ?> <?= activeIconClass('/admin') ?>">
        ...
        <a href="/playground" class="w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/playground') ?>">
        ...
        <!-- CMS: Main Dashboard -->
        <a href="/dashboard" class="w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all bg-gradient-to-r from-yellow-400 to-yellow-500 text-white shadow-lg <?= $isActive(['/dashboard']) ? 'active-dashboard' : '' ?> <?= activeIconClass('/dashboard') ?>">
        ...
        <!-- CMS: Content Group -->
        <div id="content-group" class="space-y-1">
            <button id="content-toggle" class="w-full flex items-center justify-between space-x-3 px-4 py-3 rounded-lg transition-all themed-text-secondary themed-hover <?= $contentOpen ? 'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white' : '' ?> <?= activeIconClass('/admin/pages') ?>">
                <span class="flex items-center space-x-3"><svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 <?= iconClassForAdmin('/admin/pages') ?>" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" <?= iconStyleForAdmin('/admin/pages') ?>><path d="M4 6h16M4 12h16M4 18h16"/></svg><span class="font-medium" <?= iconStyleForAdmin('/admin/pages') ?>>Content</span></span>
                <svg xmlns="http://www.w3.org/2000/svg" id="content-chevron" class="w-4 h-4 transform transition-transform themed-text-secondary <?= $contentOpen ? 'rotate-180' : '' ?>" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
            </button>
            <div id="content-sub" class="pl-10 space-y-1 <?= $contentOpen ? '' : 'hidden' ?>">
                <a href="/admin/pages" class="w-full flex items-center space-x-3 px-4 py-2 rounded-lg transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/pages') ?> <?= activeIconClass('/admin/pages') ?>">
                ...
                <a href="/admin/posts" class="w-full flex items-center space-x-3 px-4 py-2 rounded-lg transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/posts') ?> <?= activeIconClass('/admin/posts') ?>">
                ...
                <a href="/admin/categories" class="w-full flex items-center space-x-3 px-4 py-2 rounded-lg transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/categories') ?> <?= activeIconClass('/admin/categories') ?>">
                ...
                <a href="/admin/tags" class="w-full flex items-center space-x-3 px-4 py-2 rounded-lg transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/tags') ?> <?= activeIconClass('/admin/tags') ?>">
                ...
                <a href="/admin/pages/routes" class="w-full flex items-center space-x-3 px-4 py-2 rounded-lg transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/pages/routes') ?> <?= activeIconClass('/admin/pages/routes') ?>">
        ...
        <!-- Media -->
        <a href="/admin/media" class="w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/media') ?> <?= activeIconClass('/admin/media') ?>">
        ...
        <a href="/admin/users" class="w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/users') ?> <?= activeIconClass('/admin/users') ?>">
        ...
        <a href="/admin/payments" class="w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/payments') ?> <?= activeIconClass('/admin/payments') ?>">
        ...
        <!-- Navigation/Menus -->
        <a href="/admin/menus" class="w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/menus') ?> <?= activeIconClass('/admin/menus') ?>">
        ...
        <!-- Appearance / Theme -->
        <a href="/admin/themes" class="w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/themes') ?> <?= activeIconClass('/admin/themes') ?>">
        ...
        <!-- Plugins -->
        <a href="/admin/plugins" class="w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/plugins') ?> <?= activeIconClass('/admin/plugins') ?>">
        ...
        <a href="/admin/migrate" class="w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/migrate') ?> <?= activeIconClass('/admin/migrate') ?>">
        ...
        <!-- Settings -->
        <a href="/admin/settings" class="w-full flex items-center space-x-3 px-4 py-3 rounded-lg transition-all text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?= $activeClass('/admin/settings') ?> <?= activeIconClass('/admin/settings') ?>">
    ...
    <div class="mt-auto px-4 py-2 border-r border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        <?php
        ...
        <div class="flex items-center space-x-3">
            ...
            <div class="flex-1 min-w-0">
                <p class="text-sm font-semibold text-gray-900 dark:text-white truncate"><?= htmlspecialchars($adminName) ?></p>
                <p class="text-xs text-gray-500 dark:text-gray-400 truncate"><?= htmlspecialchars($adminRank) ?></p>
            </div>
