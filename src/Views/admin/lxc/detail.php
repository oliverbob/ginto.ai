...
<body class="min-h-screen bg-white dark:bg-gray-900">
        ...
        <div id="main-content" class="lg:pl-64">
            ...
            <div class="p-6 max-w-6xl mx-auto">
                ...
                <nav class="mb-4 text-sm">
                    <a href="/admin/lxc" class="text-violet-600 hover:underline">LXD Containers</a>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-2">
                            <?php if (($container['status'] ?? '') === 'Running'): ?>
                            <form method="post" action="/admin/lxc/<?= htmlspecialchars($container['name']) ?>/stop" class="inline">
                            ...
                            <form method="post" action="/admin/lxc/<?= htmlspecialchars($container['name']) ?>/restart" class="inline">
                                <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf_token ?? '') ?>">
                            ...
                            <?php else: ?>
                            <form method="post" action="/admin/lxc/<?= htmlspecialchars($container['name']) ?>/start" class="inline">
                                <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf_token ?? '') ?>">
                            ...
                            <?php endif; ?>
                            <form method="post" action="/admin/lxc/<?= htmlspecialchars($container['name']) ?>/delete" class="inline" onsubmit="return confirm('Delete container <?= htmlspecialchars($container['name']) ?>? This cannot be undone.');">
                                <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf_token ?? '') ?>">
    ...
    <script>
        ...
        async function executeCommand(e) {
            ...
            try {
                const response = await fetch('/admin/lxc/api/exec', {
                    method: 'POST',
