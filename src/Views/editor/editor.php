    ...
    <div class="editor-shell">
        ...
        <div class="editor-header">
            ...
            <div class="editor-header-right">
                ...
                <!-- GitHub Star -->
                <a href="https://github.com/oliverbob/silverqueen.pro" target="_blank" class="editor-btn editor-btn-secondary" title="Star us on GitHub" style="text-decoration:none;">
