    ...
    function ensureMallShellElements() {
        ...
        if (!document.getElementById('sidebar')) {
            ...
            sidebar.innerHTML = ''
                ...
                + '    <a class="cat-item" href="/marketplace/sellers/products" style="display:flex;align-items:center;gap:10px;text-decoration:none;color:inherit;">'
                + '      <span style="width:26px;height:26px;border-radius:8px;background:rgba(59,130,246,0.1);display:flex;align-items:center;justify-content:center;flex-shrink:0;">'
                ...
                + '      </span>My Products</a>'
                + '    <a class="cat-item" href="/marketplace/sellers/kyc" style="display:flex;align-items:center;gap:10px;text-decoration:none;color:inherit;">'
                + '      <span style="width:26px;height:26px;border-radius:8px;background:rgba(59,130,246,0.1);display:flex;align-items:center;justify-content:center;flex-shrink:0;">'
