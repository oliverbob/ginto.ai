    ...
    <aside style="display:flex;flex-direction:column;gap:18px;position:sticky;top:92px;">
        <div class="aside-card" style="border:1px solid var(--border);background:var(--surface);border-radius:24px;padding:24px;">
            ...
            <div style="display:flex;justify-content:space-between;align-items:flex-end;margin-top:10px;">
                ...
                <div style="font-size:0.9rem;color:var(--muted);text-align:right;max-width:220px;line-height:1.55;">Buyer total is item price + delivery fee. Platform and processing adjustments are internal. Fuck off</div>
            </div>
        </div>
