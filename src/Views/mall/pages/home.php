                    ...
                    <div style="width:100%;max-width:560px;background:var(--bg);border:1px solid var(--border);border-radius:14px;overflow:hidden;box-shadow:0 12px 30px rgba(0,0,0,0.45);">
                        ...
                        <div style="display:flex;flex-direction:column;gap:8px;padding:10px 14px;position:relative;">
                            ...
                            <input id="barangayMapSearchInput" type="search" name="barangayMapSearch" placeholder="Search a place or address"
                                ...
                                style="padding:10px 42px 10px 12px;border:1px solid #94a3b8;border-radius:10px;background:var(--bg, #ffffff);color:var(--text,#0f172a);font-size:0.88rem;outline:none;" />
                            ...
                            <button onclick="geocodeBarangayMapLocation()" style="position:absolute;top:50%;right:14px;width:32px;height:32px;border:none;border-radius:6px;background:transparent;color:var(--text,#0f172a);cursor:pointer;display:flex;align-items:center;justify-content:center;transform:translateY(-50%);" aria-label="Search location">
