...
class UnifiedMcpClient
{
    ...
    private function buildBasicSystemPrompt(): string
    {
        ...
        if ($hasSandbox) {
            ...
            $lines[] = "All file operations are scoped to `/root/` inside the sandbox container.";
            $lines[] = "";
            ...
            $lines[] = "";
            $lines[] = "### File Operations (paths are relative to /root/)";
            $lines[] = "- `sandbox_list_files` - List files and directories. Parameters: `path` (optional, relative to /root/)";
            ...
            $lines[] = "- `sandbox_delete` - Delete a file or folder. Parameters: `path` (required)";
            ...
            $lines[] = "- `sandbox_exec` - Run shell commands in the sandbox. Parameters: `command` (required), `cwd` (optional, default '/root')";
            $lines[] = "";
            ...
            $lines[] = "";
            $lines[] = "### 📄 Document Creation (REQUIRED for documents)";
            $lines[] = "- `sandbox_create_document` - **ALWAYS USE THIS FOR DOCUMENTS** - Creates real PDF, DOCX, ODT files. Parameters: `filename` (required), `content` (required, in Markdown), `format` (optional: pdf, docx, odt, html, rtf, md, txt - default: pdf), `title` (optional), `folder` (optional)";
            $lines[] = "- `sandbox_list_document_formats` - List all available document formats";
            $lines[] = "";
            $lines[] = "⚠️ **NEVER use sandbox_write_file + sandbox_exec for documents!** The sandbox_create_document tool handles Pandoc/wkhtmltopdf conversion automatically.";
            $lines[] = "";
            $lines[] = "### Status";
            $lines[] = "- `sandbox_status` - Get sandbox container status";
            $lines[] = "";
            $lines[] = "## Path Examples";
            $lines[] = "- To create `/root/index.php`, use path: `index.php`";
            $lines[] = "- To create `/root/project/src/app.js`, use path: `project/src/app.js`";
            $lines[] = "";
        } else {
