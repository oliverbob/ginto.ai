...
<body class="bg-gray-100 dark:bg-dark-800 font-sans transition-colors duration-200">
    ...
    <!-- Main Content -->
    <main class="max-w-7xl mx-auto pt-16 pb-20 grid grid-cols-1 lg:grid-cols-12 main-content">
        <!-- Left Sidebar -->
        <aside class="hidden lg:block lg:col-span-2 pr-4 left-sidebar">
            <div class="sidebar-container sticky top-16 h-[calc(100vh-64px)] overflow-y-auto scrollbar-hide">
                <div class="space-y-2 mt-2">
                    <a href="/profile/<?= htmlspecialchars($_SESSION['user_id']) ?>" class="flex items-center p-2 hover:bg-gray-200 dark:hover:bg-dark-600 rounded-lg">
...
<script>
    ...
    const currentUserData = { // Ensure this is populated by PHP
        ...
        profile_picture: <?php echo json_encode($_SESSION['user_profile_picture'] ?? null); ?> // THIS IS KEY
    };
