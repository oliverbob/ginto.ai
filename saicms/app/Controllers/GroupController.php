...
class GroupController extends Controller {
    ...
    /**
     * Handles the creation of all types of posts (text, media, check-in, share).
     * This method is designed to be used by any controller that creates a post.
     */
    public function post()
    {
        ...
        // 4. --- MODIFIED VALIDATION: Check for any valid content type ---
        ...
        if ($isShare && filter_var($input['shared_post_id'], FILTER_VALIDATE_INT)) {
            ...
            $dataToInsert['post_type'] = 'share'; // A share is always of post_type 'share'
        }
        ...
        // ========== MODIFICATION START ==========
        // 6.5 --- URL METADATA EXTRACTION ---
        // If there is text content, check it for a URL to create a link preview.
        if ($hasText) {
            $urlExtractor = new URLMDController(); 
            $metadata = $urlExtractor->extractUrlMetadata($content);

            // If a URL was found and metadata was fetched successfully, add it to the post data.
        ...
        // 8. --- PREPARE AND RETURN FULL RESPONSE ---
        // Use the central fetchCompletePostData method to ensure consistency
    ...
    protected function fetchCompletePostData($postId, array $seenIds = []) {
        ...
        $post = $this->db->get("posts (p)",
            ...
            [
                ...
                // ========== MODIFICATION START ==========
                // Add the new link preview fields to the select statement
    ...
    /**
     * Helper function to get the current user's friend IDs.
     * This is required to check for 'friends' visibility posts.
     * Based on the `friends` table schema you provided.
     */
    ...
    public function feed() {
        ...
        // This is your original line, untouched.
        $selectColumns = ["p.id"];
        ...
        if ($this->currentUserId) {
            ...
            // 1. It's 'public', OR
            // 2. The user is the author (sees their own 'private' and 'friends' posts), OR
            // 3. The post is 'friends' visibility AND the author is a friend.
            $visibilityRules = [
                "p.visibility" => "public",
            ...
            // This is your original logic for guests, untouched.
    ...
    public function getPost($postId) {
        ...
        // Add friends logic for 'friends' visibility here if needed
    ...
    /**
     * This method is being restored and fixed.
     * It now correctly uses the central fetchCompletePostData method.
     */
    public function getPostById($postId) {
        // This method's logic is now identical to getPost(), ensuring consistency.
        // It simply delegates to the robust, centralized fetching logic.
        $this->getPost($postId);
    }
