...
class UploadController extends Controller
{
    ...
    public function createPostWithMedia()
    {
        ...
        try {
            ...
            $postDataForDb = [
                'user_id' => $currentUserId, 'author_id' => $currentUserId, 'content' => $postContent, 'image' => $mediaUrlForPost,
    ...
    private function _pm_fetchFullPostData(int $postId): ?array
    {
        ...
        $postData = $this->db->get('posts', [
            ...
            'u.fullname AS full_name', 'u.username', 'u.profile_picture(user_avatar_url)', 
