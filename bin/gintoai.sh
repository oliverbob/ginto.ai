...
prompt_install_mode() {
    ...
    echo "               Best for: Dedicated servers, VPS, development machines"
    echo ""
    echo "  2) docker  - Run everything in Docker containers"
    echo "               Best for: Quick setup, testing, portable deployments"
    echo ""
