...
EOF
    ...
    # Generate sudoers content for all web users
    {
        ...
        for user in $lxc_users; do
            ...
            echo "$user ALL=(root) NOPASSWD: /snap/bin/lxc launch ginto-sandbox-image sandbox-*"
            ...
            echo ""
            echo "# List and info operations (read-only, safe to allow broadly)"
            echo "$user ALL=(root) NOPASSWD: /snap/bin/lxc version"
