...
function ginto_tunnel_access_denied_key(string $message = 'This tunnel requires a valid access token.'): void {
    ...
    echo '<!doctype html><html><head>'
        ...
        .'style="width:100%;height:44px;box-sizing:border-box;padding:10px 44px 10px 12px;border-radius:12px;border:1px solid #cbd5e1;background:#ffffff;color:#0f172a;font-size:15px;" />'
