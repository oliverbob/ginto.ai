...
**Step 2**: Convert to PDF using Pandoc or wkhtmltopdf
...
4. **Convert to PDF** using pandoc or wkhtmltopdf
...
- **wkhtmltopdf** - Generate PDFs from HTML/CSS
...
>
> **Your options:**
> 1. **Use pre-installed tools**: PHP 8.2, Python 3, Node.js (runtime only), Git, Pandoc, wkhtmltopdf
...
| **wkhtmltopdf** | HTML/CSS to PDF | `wkhtmltopdf page.html output.pdf` |
...
│   ✅ Pandoc, wkhtmltopdf (document creation)                     │
│   ✅ Git, Vim, Nano, Bash                                       │
